function lgraph = googlenetPD(image_size,num_fully_connected_layers)
%googlenetPD uses DL model, GoogLeNet
% takes 2 inputs: image size and number of fully connected layers
%   return a layer graph
% PD Aug 31, 2022
...
tempLayers = [
    ...
    dropoutLayer(0.1,"Name","pool5-drop_7x7_s1")
    fullyConnectedLayer(num_fully_connected_layers,"Name","loss3-classifier","BiasLearnRateFactor",2)
